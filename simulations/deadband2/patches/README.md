...
```bash
git -C repos/andes apply simulations/deadband2/patches/andes_deadband2.patch
git -C repos/ams apply simulations/deadband2/patches/ams_runtime_compat.patch
```
